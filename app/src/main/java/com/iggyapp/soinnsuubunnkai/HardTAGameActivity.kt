...
import kotlinx.android.synthetic.main.activity_tagame.gsme_boad
...
class HardTAGameActivity : AppCompatActivity() {
    ...
    //問題作成
    fun createQuestion(){
        answerTwoNumber = (0..4).random()
        answerThreeNumber = (0..4).random()
        answerFiveNumber = (0..4).random()
        answerSevenNumber = (0..3).random()
